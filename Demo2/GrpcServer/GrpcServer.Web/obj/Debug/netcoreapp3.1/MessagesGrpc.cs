...
namespace GrpcServer.Web.Protos {
  public static partial class EmployeeService
  {
    ...
    public abstract partial class EmployeeServiceBase
    {
      ...
      public virtual global::System.Threading.Tasks.Task<global::GrpcServer.Web.Protos.TokenResponse> CreateToken(global::GrpcServer.Web.Protos.TokenRequest request, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, EmployeeServiceBase serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_CreateToken, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::GrpcServer.Web.Protos.TokenRequest, global::GrpcServer.Web.Protos.TokenResponse>(serviceImpl.CreateToken));
    }
